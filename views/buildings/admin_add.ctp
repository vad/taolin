  ...
  <div id="main">
    <div class="block">
      <div class="secondary-navigation">
        <ul><li class="first"><a href="<? echo $this->base.DS."admin/buildings" ?>">Buildings list</a></li></ul>
        <ul><li class="active"><a href='#top'>Add new</a></li></ul>
        <div class="clear" />
      </div>
      <div class="content">
        <div class="inner">
          <h2 class="title">Create new building</h2>
          <br />
...
<div id="sidebar">
  <div class="block">
    <h3>Help</h3>
    <div class="content">
      <p>In this page you can create a new building. If you have any problem please submit an Issue on <a href="http://github/vad/taolin/issues">Github</a></p>
    </div>
  </div>
</div>
