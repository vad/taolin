<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    <xsl:template match="/">
        ...
        <div id="tomorrow" class="meteo_forecast" label="Domani">
            ...
            <xsl:if test="not($cieloDesc='')"><div class="meteo_report"><b>Himmel: </b><xsl:value-of select="Domani/CieloDesc"/></div><br /></xsl:if>
            <div class="meteo_image">
                <h2>Morgen</h2>
        ...
        <div id="day_after_tomorrow" class="meteo_forecast" label="Dopo domani">
            ...
            <xsl:if test="not($cieloDesc='')"><div class="meteo_report"><b>Himmel: </b><xsl:value-of select="DopoDomani/CieloDesc"/></div><br /></xsl:if>
            <div class="meteo_image">
                <h2>Morgen</h2>
