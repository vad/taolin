   ...
   lastOptions : null,
    ...
    load : function(options){
        ...
        if(this.fireEvent("beforeload", this, options) !== false){
            ...
            /* In order to pass parameters to store.load dynamically
             * I made this change:
             * The previous code modifies a passed object, so the two need 
             * to be merged into a third object really. This code copies the 
             * baseParams into the empty object first, and then copies the options.params in after
             *
             * Further info:
             * http://extjs.com/forum/showthread.php?t=31966
             *
             * WARNING: Now it is not modified!!!
             */
