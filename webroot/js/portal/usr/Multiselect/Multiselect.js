 ...
 *
 * This file is a modified version of a file of Ext JS Library 2.2
 * (see copyright below).
 * According to the Ext JS Library 2.2 license (see
 * http://extjs.com/license ), Ext JS Library 2.2 is double licensed.
...
Ext.ux.ItemSelector = Ext.extend(Ext.form.Field,  {
    ...
    onRender: function(ct, position){
		...
		var tb = p.body.first();
		//this.el.setWidth(p.body.first().getWidth()+20);
		p.body.removeClass();
