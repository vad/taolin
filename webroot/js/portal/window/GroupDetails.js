...
GroupDetails.prototype = {
	...
	initTemplates : function(){
	    this.usersTemplate = new Ext.XTemplate(
			'<tpl for=".">',
				'<div class="thumb-wrap u-hover" style="text-decoration:none !important;" id="{photo}{id}" onclick="showUserInfo({id}, null, {source: \'group window\'})">',
                    ...
                    /*'<tpl for="groups">',
                        '<br /><span onclick="groupDetails(\'{id}\', \'{name}\', \'' + Ext.util.Format.htmlEncode('{"source": "group window", "group_id": "{id}"}') + '\')">{name}</span>',
                    '</tpl>',*/
                '</div>',
			'</tpl>', {
