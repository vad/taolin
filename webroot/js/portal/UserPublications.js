        ...
        this.store = new Ext.data.JsonStore({
            ...
            ,listeners: {
                beforeload: function(){
                    ...
                    var emptytext = '<div style="padding:10px 5px;font-size:100%"><div class="warning-msg border_radius_5px">No publications for this user</div><br />You might <a href="javascript:void(0)" onclick="new SendToWindow(\'I would like to suggest you to add your publications to FBK publik repository at http://www.itc.it/publik/\', \[\[\''+user_email+'\',\''+user_name+' '+user_surname+'\'\]\],  \'' + Ext.util.Format.htmlEncode('{"source": "user profile publik tab","user_id":"'+user_id+'"}') + '\')">suggest '+user_name+' to add publications</a> using FBK publik repository.<br /><br /><br />But did you remember to add your publications at the website <a href="http://www.itc.it/publik/" target="_blank" />http://www.itc.it/publik/</a> ?</div>';
