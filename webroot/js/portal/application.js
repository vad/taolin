...
function application_init(){
    ...
    var clear_html = 
        '<div id="logout_div" class="right-element">'
            ...
            + '<img src="js/portal/shared/icons/fam/new.png"/><a href="./wiki" class="new-item" target="_blank">FBK wiki</a> | '
            + '<a href="./pages/privacy_policy" class="new-item" target="_blank">Privacy policy</a> | '
