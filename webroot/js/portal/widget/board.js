                    ...
                    '<tpl if="this.isOwner(user_id)">',
                        ...
                        '<span class="board-img">',
                            ...
                            '<tpl if="commentsCount &gt; 0">',
                                '<span onclick="openCommentWindow(\'Board\',{id},$(\'#'+this.getId()+'-{id}-text\'))">',
                ...
                /* User is not the owner of the message */    
                    '<tpl if="!this.isOwner(user_id)">',
                        ...
                        '<span class="board-img">',
                            ...
                            '</tpl>',
                            '<tpl if="commentsCount &lt;= 0">',
                                '<span onclick="openCommentWindow(\'Board\',{id},$(\'#'+this.getId()+'-{id}-text\'))"><img src="js/portal/shared/icons/fam/comment_add.png" title="Add a comment"></span>',
                            '</tpl>',
                        '</span>',
