        ...
        timelineTemplate = new Ext.XTemplate( 
            '<div>',
                '<tpl>',
                    ...
                    '<br/>',
                    // Pagination
                    '<div style="margin: 30px 50px; text-align: center; border:1px solid gray; padding: 5px 0; color:gray;">',
                        ...
                        '<tpl if="this.isFirstPage()">',
                            ...
                            '<img src="img/icons/fugue/control-180-small.png" class="size16x16" style="vertical-align:top;"/><span style="color: gray;">Newer</span>',
                        '</tpl>',
                        ...
                        '</tpl>',
                        '<tpl if="this.isLastPage()">',
                            '<span style="color: gray;>Older</span><img src="img/icons/fugue/control-000-small.png" class="size16x16" style="vertical-align:top;"/>',
