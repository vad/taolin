                    ...
                    '<div class="timeline-pagination">',
                        '<div class="left-div">',
                            '<tpl if="!this.isFirstPage()">',
                                '<span class="pagination-item"><img src="img/icons/fugue/control-double-180-small.png" class="size16x16" style="vertical-align:top;"/><a href="javascript:void(0)" onclick="Ext.getCmp(\'{[this.parent.id]}\').paginateTimeline(0)">Newest</a></span>',
                                '<span class="pagination-item"><img src="img/icons/fugue/control-180-small.png" class="size16x16" style="vertical-align:top;"/><a href="javascript:void(0)" onclick="Ext.getCmp(\'{[this.parent.id]}\').paginateTimeline(1)">Newer</a></span>',
                            '</tpl>',
                        '</div>',
                        '<div class="right-div">',
                            '<tpl if="!this.isLastPage()">',
                                '<span class="pagination-item"><a href="javascript:void(0)" onclick="Ext.getCmp(\'{[this.parent.id]}\').paginateTimeline(2)">Older</a><img src="img/icons/fugue/control-000-small.png" class="size16x16" style="vertical-align:top;"/></span>',
                                '<span class="pagination-item"><a href="javascript:void(0)" onclick="Ext.getCmp(\'{[this.parent.id]}\').paginateTimeline(3)">Oldest</a><img src="img/icons/fugue/control-double-000-small.png" class="size16x16" style="vertical-align:top;"/></span>',
                            '</tpl>',
                        '</div>',
                    '</div>',
                    /* END OF PAGINATION */
